package com.vatlythuvi.Baitap.Chuyende5.Chude1;
...
public class ActivityChuyende5_Chude1_Dang1 extends AppCompatActivity {
    ...
    protected void updateQues() {
        DocumentReference docRef = db.collection("vatly10_5_1_1")
