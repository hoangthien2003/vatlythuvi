package com.vatlythuvi.Baitap.Chuyende6.Chude1;
...
public class ActivityChuyende6_Chude1_Dang4 extends AppCompatActivity {
    ...
    protected void updateQues() {
        DocumentReference docRef = db.collection("vatly10_6_1_4")
