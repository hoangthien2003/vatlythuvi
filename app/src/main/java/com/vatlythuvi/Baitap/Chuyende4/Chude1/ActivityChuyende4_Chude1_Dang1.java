package com.vatlythuvi.Baitap.Chuyende4.Chude1;
...
public class ActivityChuyende4_Chude1_Dang1 extends AppCompatActivity {
    ...
    protected void updateQues() {
        DocumentReference docRef = db.collection("vatly10_4_1_1")
